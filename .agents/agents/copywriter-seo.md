...
### Page Title Format (Laravel Inertia Head)
```vue
<!-- In Vue Inertia pages, use <Head> component -->
<Head title="Buy Running Shoes Online — Free Shipping | SportShop" />

<!-- Pattern: [Primary Keyword] — [Secondary Context] | [Brand Name] -->
```
...
### URL Structure (Laravel Routes)
```php
// Rules: lowercase, hyphens not underscores, descriptive
// ❌ /products?cat=12&id=456
// ❌ /p/running_shoes_for_men
// ✅ /shoes/mens-running-shoes
// ✅ /blog/how-to-choose-running-shoes

Route::get('/shoes/{category}', [ProductController::class, 'byCategory'])->name('shoes.category');
